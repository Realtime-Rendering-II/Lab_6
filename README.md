...
```
git clone --recursive https://github.com/Realtime-Rendering-II/Lab_6.git
```  
...
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/CMake-0.png) 
  ...
  select the source (C:\\..\Lab_6) and build folder (C:\\..\Lab_6\build)    
...
Images:
========================
Without retriangulation:
 ![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/no_retriangulation.png)

With retriangulation:
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/retriangulated.png)
